package com.example.yambaClient;
...
public final class YambaClient {
	...
	public static interface TimelineProcessor {
		...
		/**
		 * @param id
		 *            the unique id for the status message
		 * @param createdAt
		 *            creation time for the status message
		 * @param user
		 *            user posting the status message
		 * @param msg
		 *            the text of the status message
		 */
		public void onTimelineStatus(long id, Date createdAt, String user,
				String msg);
	}
	 ...
	 * 
	 * @param maxPosts
	 *            max on length of the timeline
	 * @return a list of Status objects
	 * @throws YambaClientException
	 */
	public List<Status> getTimeline(final int maxPosts)
			throws YambaClientException {
	 ...
	 * 
	 * @param hdlr
	 *            callback handler for each status
	 * @throws YambaClientException
	 */
	...
	private void parseStatus(XmlPullParser xpp, InputStream in,
			TimelineProcessor hdlr) throws XmlPullParserException, IOException,
			ParseException {
